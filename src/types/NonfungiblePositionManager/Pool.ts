...
export class Pool extends ethereum.SmartContract {
  ...
  secondsInside(tickLower: i32, tickUpper: i32): BigInt {
    let result = super.call(
      "secondsInside",
      "secondsInside(int24,int24):(uint32)",
  ...
  secondsOutside(param0: i32): BigInt {
    let result = super.call(
      "secondsOutside",
      "secondsOutside(int24):(uint256)",
  ...
  try_secondsOutside(param0: i32): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "secondsOutside",
      "secondsOutside(int24):(uint256)",
      [ethereum.Value.fromI32(param0)]
  ...
  ticks(param0: i32): Pool__ticksResult {
    let result = super.call(
      "ticks",
      "ticks(int24):(uint128,int128,uint256,uint256)",
      [ethereum.Value.fromI32(param0)]
    );
