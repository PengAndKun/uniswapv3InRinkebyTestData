...
export class TickHourData extends Entity {
  ...
  get liquidityGross(): BigDecimal {
    let value = this.get("liquidityGross");
    return value.toBigDecimal();
  }

  set liquidityGross(value: BigDecimal) {
    this.set("liquidityGross", Value.fromBigDecimal(value));
  }

  get liquidityNet(): BigDecimal {
    let value = this.get("liquidityNet");
    return value.toBigDecimal();
  }

  set liquidityNet(value: BigDecimal) {
    this.set("liquidityNet", Value.fromBigDecimal(value));
  }
